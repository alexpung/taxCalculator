...
from capital_gain.model import CgtCalculator, Transaction, TransactionType
...
class TestCalculator(unittest.TestCase):
    ...
    def test_bed_and_breakfast_matching(self) -> None:
        ...
        self.assertEqual(Decimal(100), test.transaction_list[0].match_status.unmatched)
        self.assertEqual(
            Decimal(0), test.transaction_list[0].match_status.bed_and_breakfast
        )
        self.assertEqual(Decimal(30), test.transaction_list[1].match_status.unmatched)
        self.assertEqual(
            Decimal(20), test.transaction_list[1].match_status.bed_and_breakfast
        )
        self.assertEqual(Decimal(0), test.transaction_list[2].match_status.unmatched)
        self.assertEqual(
            Decimal(20), test.transaction_list[2].match_status.bed_and_breakfast
        )
        self.assertEqual(Decimal(30), test.transaction_list[3].match_status.unmatched)
        self.assertEqual(
            Decimal(0), test.transaction_list[3].match_status.bed_and_breakfast
        )
        self.assertEqual(Decimal(10), test.transaction_list[4].match_status.unmatched)
        self.assertEqual(
            Decimal(10), test.transaction_list[4].match_status.bed_and_breakfast
        )
        self.assertEqual(Decimal(0), test.transaction_list[5].match_status.unmatched)
        self.assertEqual(
            Decimal(10), test.transaction_list[5].match_status.bed_and_breakfast
        )
        self.assertEqual(Decimal(10), test.transaction_list[6].match_status.unmatched)
        self.assertEqual(
            Decimal(0), test.transaction_list[6].match_status.bed_and_breakfast
        )
